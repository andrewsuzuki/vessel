...
Route::group(array('prefix' => Config::get('vessel::vessel.uri', 'vessel')), function()
{
	Route::group(array('before' => 'vessel_auth'), function()
	{
		...
		Route::group(array('before' => 'p.blocks_manage'), function()
		{
		...
		Route::group(array('before' => 'p.menus_manage'), function()
		{
		...
		Route::group(array('before' => 'p.media_manage'), function()
		{
		...
		Route::group(array('before' => 'p.users_manage'), function()
		{
		...
		Route::group(array('before' => 'p.settings_manage'), function()
		{
		...
		Route::group(array('before' => 'p.user_settings_manage'), function()
		{
	...
	Route::group(array('before' => 'vessel_guest'), function()
	{
		...
		Route::get('register/confirm/{confirmation}', array('as' => 'vessel.register.confirm', 'before' => 'registration_enabled', 'uses' => 'Hokeo\\Vessel\\UserController@getRegisterConfirm'));
	});
